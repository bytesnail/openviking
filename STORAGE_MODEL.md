...
> **版本基线**:基于容器内 `openviking-server v0.4.4` 源码核对。版本随 `latest` 镜像自动更新(`update-openviking.sh` 每天 6:30),以 `openviking-server --version` 为准。
...
tags, search_tags, abstract, account_id, owner_user_id, owner_agent_id
```
